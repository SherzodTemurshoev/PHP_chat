<?php
  ...
  if ($view != "")
  {
    ...
    echo <<<_END
      ...
      Публично<input type='radio' name='pm' value='0' checked='checked'>
      Приватно<input type='radio' name='pm' value='1'>
...
_END;
  ...
  echo "<br><a class='button' href='messages.php?view=$view'>Обновить сообения</a>";
?>
